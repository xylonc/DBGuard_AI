...
def build_review_bundle(handoff, result, engine):
    ...
    require(fix['apply'] == template_action(result['rendered_apply_sql']), 'typed action differs from tested template')
    ...
    apply_statements = canonical_apply(result['rendered_apply_sql'])
